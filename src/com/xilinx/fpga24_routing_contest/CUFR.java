...
import com.xilinx.rapidwright.rwroute.PartialRouterParallel;
...
public class CUFR {
    public static void main(String[] args) throws IOException {
        ...
        PartialRouterParallel.routeDesignWithUserDefinedArguments(design, routerArgs.toArray(new String[0]),
